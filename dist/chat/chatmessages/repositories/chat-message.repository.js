...
let ChatMessageRepository = class ChatMessageRepository extends base_repository_1.BaseRepository {
    ...
    async findRoomMessages(roomId, queryDto) {
    ...
    async markMessagesAsRead(roomId, recipientId) {
        await this.chatMessageRepository.update({ roomId, isRead: false }, { isRead: true, readAt: new Date() });
    }
};
